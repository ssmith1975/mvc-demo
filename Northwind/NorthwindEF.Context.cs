...
namespace Northwind
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Product> GetTopSellerProducts()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Product>("GetTopSellerProducts");
        }
    
        public virtual ObjectResult<Product> GetTopSellerProducts(MergeOption mergeOption)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Product>("GetTopSellerProducts", mergeOption);
        }
    }
}
